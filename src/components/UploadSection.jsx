      ...
      <section id="upload" className="py-24 px-4 sm:px-6 lg:px-8">
        <div className="max-w-2xl mx-auto text-center">
          <div className="bg-card rounded-3xl p-12 shadow-lg">
            ...
            <p className="text-xl font-semibold text-text animate-pulse">
    ...
    <section id="upload" className="py-24 px-4 sm:px-6 lg:px-8">
      <div className="max-w-2xl mx-auto">
        ...
        <p className="text-text-secondary text-center mb-10">
          Upload your CV below and brace yourself.
        </p>
        ...
        <div className="text-center mt-6">
          <button
            onClick={() => fileInputRef.current?.click()}
            className="px-8 py-4 bg-primary text-white font-semibold rounded-xl text-lg shadow-lg shadow-primary/25 hover:shadow-primary/40 transition-all duration-300 animate-pulse-soft hover:animate-none hover:scale-105 active:scale-95"
          >
            🔥 Upload & Get Roasted
          </button>
        </div>
